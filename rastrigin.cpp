...
int main()
{
    ...
    fout.open("Rastrigin_excel.csv");
    myfile.open("rastrigin_graph.csv");
    float runMin[50];
    const int iter=200;
    for (int w = 0; w < 50; w++)
    {
        ...
        while (b <= iter-1)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                {
                    xp = pow(arr1[i][j], 2);
                    xtri = 10 * cos(2 * pi * arr1[i][j]);
                    sum_f += (xp - xtri);
                }
                costRes[i] = term1 + sum_f;
            }
            ...
            for (int p = 0; p < 10; p++)
            {
                ...
                {
                    xp = pow(arrXoff1[j], 2);
                    xtri = 10 * cos(2 * pi * arrXoff1[j]);
                    sum_f1 += (xp - xtri);
                }
                Xoffcost = term1 + sum_f1;
